    ...
    <>
      <div className="p-4 bg-white rounded-xl">
        <div className="flex flex-col gap-6 mt-10">
          <div className="w-full mx-auto bg-primary border border-primary rounded-lg p-6 mb-4 flex flex-col relative">
            ...
            <div
              className="absolute top-7 left-4 flex items-center text-white hover:text-gray-300 cursor-pointer"
